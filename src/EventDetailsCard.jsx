...
const EventDetailsCard = () => {
    return (
        <div className="event-description flex flex-col bg-black/60 shadow-lg ring-1 ring-black/5 backdrop-blur-2xl border-white border-b-4 border-t-4">
            ...
            <div className="fight-poster-container w-screen h-screen my-4">
                <h1 className="text-white text-3xl text-center my-5">
                    FIGHTS
                </h1>

                <div className="grid justify-center items-center grid-cols-3 gap-4 mx-8">
                    <div className="">
